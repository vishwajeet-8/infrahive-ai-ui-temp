...
//   // Function to fetch cause list data
...
//       const response = await fetch(`/court-api/eciapi/17/district-court/cause-list`, {
//         method: "POST",
//         headers: {
...
//             <h3 className="text-lg font-medium">Cause List - {date ? new Date(date).toLocaleDateString() : ""}</h3>
...
//       {searchPerformed && (!causeList || causeList.length === 0) && !isLoading && !error && (
