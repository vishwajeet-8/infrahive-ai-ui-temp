...
const CatAdvocateSearchPage = ({ court }) => {
  ...
  //       "https://infrahive-ai-legal-research-gyfsavdfd0c9ehh5.centralindia-01.azurewebsites.net/legal-infrahive/central-administrative-tribunal/search-advocate-name/",
  //       {
  //         method: "POST",
  //         headers: {
  ...
  // Existing handleClear function (unchanged)
  const handleClear = () => {
    setName("");
    setType("");
    setBenchId("");
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Example: Manish</p>
              </div>
              <div>
                <label
                  htmlFor="type"
