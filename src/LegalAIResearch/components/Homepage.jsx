...
// const HomePage = ({ courts, toggleDropdown }) => {
//   return (
//     <div className="p-6">
//       <h1 className="text-2xl font-bold mb-4">Welcome to Legal Case Dashboard</h1>
//       <div className="bg-white p-6 rounded-md border border-gray-200">
//         <p className="text-gray-700 mb-4">
//           Select a court from the sidebar to begin searching for cases and orders.
//         </p>
...
//         {/* Normal Cards View - show only when not in search mode */}
//         {!isSearchMode && (
//           <div className="flex flex-wrap gap-6 ml-auto mr-auto justify-center">
//             {isLoading
//               ? // Skeleton loading cards
