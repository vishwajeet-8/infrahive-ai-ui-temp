...
import { AlertTriangle, Star, ShoppingCart, X } from "lucide-react";
...
const DistrictAdvocateSearchPage = ({ court }) => {
  ...
  const handleFollowCase = async (caseData, rowIndex) => {
    ...
    try {
      const caseToSave = {
        ...
        advocateName:
          caseData.advocateName || caseData.advocate || name || "N/A",
  ...
  //       "https://infrahive-ai-legal-research-gyfsavdfd0c9ehh5.centralindia-01.azurewebsites.net/legal-infrahive/district-court/search/advocate-name/",
  //       {
  //         method: "POST",
  //         headers: {
        ...
        const filteredCases =
          court.cases?.filter(
            (caseItem) =>
              ...
              (caseItem.advocate &&
                caseItem.advocate.toLowerCase().includes(query)) ||
              (caseItem.filing &&
                          ...
                          court.cases.map((caseItem, caseIndex) => (
                            ...
                            >
                              ...
                              <td className="px-4 py-3 text-sm text-gray-900">
                                <button
                                  onClick={() =>
                                    handleViewDetails(caseItem.cnr)
                                  }
                                  disabled={
                                    detailsLoading &&
...
// EnhancedDistrictCaseDetailsModal remains unchanged
const EnhancedDistrictCaseDetailsModal = ({
  caseDetails,
  isLoading,
  error,
  onClose,
...
export default DistrictAdvocateSearchPage;
