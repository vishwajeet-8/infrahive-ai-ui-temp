...
//         <h1 className="text-xl font-semibold text-gray-800">Indian Courts Dashboard</h1>
...
//             className="pl-10 pr-4 py-2 w-full border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 transition-all"
//           />
//         </div>
//       </div>
//     </header>
...
//           {showResults && (
//             <div className="absolute mt-2 w-96 -right-16 bg-white rounded-md shadow-lg z-20 border border-gray-200">
...
//                       <div className={`w-8 h-8 ${result.iconBg} rounded-md flex items-center justify-center text-gray-700 font-semibold mr-2`}>
//                         {result.icon}
//                       </div>
