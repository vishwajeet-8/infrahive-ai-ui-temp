      ...
      <div className="relative px-6 py-24 bg-[#0f172a] overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            ...
            <div className="mt-16">
              <button className="relative overflow-hidden px-8 py-3 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] group">
                ...
                <span className="absolute top-0 left-0 w-10 h-full bg-white/30 -skew-x-12 -translate-x-16 group-hover:translate-x-64 transition-transform duration-700"></span>
              </button>
            </div>
          </div>
        </div>
