...
//                   {ws.is_default && "Default Workspace"}
//                 </p>
//               </div>
//               {!ws.is_default && (
//                 <button
...
// import React, { useEffect, useState } from "react";
// import { Trash2, Plus, Folder, Star, Search, RefreshCw } from "lucide-react";
...
//       setLoading(true);
//       setError(null);
//       const response = await mockApi.get("/get-workspaces", {
//         headers: {
...
//     try {
//       await mockApi.delete(`/workspace/${workspaceId}`, {
//         headers: {
//           Authorization: `Bearer mock-token`,
//         },
//       });
...
//     alert("Create new workspace functionality would be implemented here");
//   };
...
//                 <div
//                   key={ws.id}
//                   className="flex justify-between items-center p-4 border rounded-lg hover:shadow-sm transition-shadow bg-gray-50 hover:bg-white"
//                 >
