...
// // components/EditorToolbar.jsx - Toolbar Component
...
// components/EditorToolbar.jsx - Enhanced Toolbar with Image Upload
...
// // components/EditorToolbar.jsx - Enhanced with Image Size Management
// import React, { useRef, useEffect, useState } from 'react';
// import { 
//   Bold, 
//   Italic, 
...
//     { label: 'Full Width (100%)', value: 'fullwidth', width: '100', height: '', unit: '%' },
//     { label: 'Half Width (50%)', value: 'halfwidth', width: '50', height: '', unit: '%' },
...
//     if (imageSize.maintainAspectRatio && imageSize.originalWidth && imageSize.originalHeight) {
...
//                     value={sizePreset}
//                     onChange={(e) => {
//                       const preset = sizePresets.find(p => p.value === e.target.value);
...
//                           onChange={(e) => setImageSize(prev => ({ ...prev, unit: e.target.value }))}
//                           className="w-full px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
//                         >
//                           {units.map(unit => (
...
//                     <strong>Original:</strong> {imageSize.originalWidth} × {imageSize.originalHeight}px
//                   </div>
//                 )}
//               </div>
//             </div>
...
// components/EditorToolbar.jsx - Enhanced with Image Size Management and Exit Block Button
// import React, { useRef, useEffect, useState } from 'react';
// import { 
//   Bold, 
//   Italic, 
...
//   X,
//   Maximize2,
//   ArrowRightFromLine // Exit Block icon
// } from 'lucide-react';
...
//           console.log('Successfully created new paragraph at position:', pos + 1);
//           return;
//         }
...
//     const exitableBlocks = ['blockquote', 'codeBlock', 'heading', 'bulletList', 'orderedList', 'listItem'];
